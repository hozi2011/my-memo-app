...
addButton.addEventListener('click', () => {
    ...
    let dateValue = memoDate.value; // letに変更
...
// プロジェクトを読み込むたびに、最後に使ったプロジェクトを保存する
...
loadProjectButton.addEventListener('click', () => {
    ...
    clearPage();
    loadMemos();
    localStorage.setItem('lastProject', currentProject); // ここにも追加
});